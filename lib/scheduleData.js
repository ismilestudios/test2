...
export const STATUSES = ['Needs Photographers Need Assistant Assigned', 'Need Assistant Assigned', 'Rain Watch', 'Completed'];
...
export const historicalScheduleEvents = [
  ...
  },
  {
    ...
    assistants: [],
    features: [],
    notes: "Need Assistant Assigned by Studio.",
  },
  {
  ...
  },
  {
    ...
    "canonicalSchoolName": "Kindercare Clifton Park",
    "eventType": "Fall Picture Day",
    "status": "Needs Photographers Need Assistant Assigned",
    "photographers": [
      "Beth"
    ],
    "assistants": [
...
export const EVENTS = historicalScheduleEvents.map((event) => {
  ...
  return {
    ...
    status: event.status || 'Need Assistant Assigned',
