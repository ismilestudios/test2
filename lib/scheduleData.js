...
export const TYPE_COLORS = {
  'Fall Picture Day': 'bg-[#DDE8D2] text-zinc-900 border-[#7F936D]',
  'Spring Picture Day': 'bg-emerald-50 text-emerald-900 border-emerald-200',
  Seniors: 'bg-yellow-200 text-yellow-950 border-yellow-500',
  Sports: 'bg-yellow-50 text-yellow-800 border-yellow-200',
  'Rain Date': 'bg-sky-50 text-sky-900 border-sky-200',
  'Makeup Day': 'bg-rose-50 text-rose-900 border-rose-200',
  'Call or Meeting': 'bg-zinc-700 text-white border-zinc-800',
  'Photo Booth': 'bg-pink-50 text-pink-900 border-pink-200',
  'Family Photos': 'bg-blue-100 text-blue-950 border-blue-500',
  Headshots: 'bg-blue-100 text-blue-950 border-blue-500',
  'Special Event': 'bg-blue-100 text-blue-950 border-blue-500',
  'Edit Day': 'bg-zinc-100 text-zinc-800 border-zinc-300',
  'Time Off': 'bg-zinc-400 text-zinc-950 border-zinc-600',
  'Personal Appointment': 'bg-zinc-400 text-zinc-950 border-zinc-600',
  'School Holiday Calendar': 'bg-zinc-400 text-zinc-950 border-zinc-600',
  'Studio Assigned Schools (SAS)': 'bg-purple-300 text-purple-950 border-2 border-purple-800 border-l-4 border-l-purple-950 font-extrabold shadow-lg ring-2 ring-purple-500/80'
};
