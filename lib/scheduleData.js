...
export const SCHOOLS = [
  ...
  },
  {
    ...
    "irm": 89,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: This is the one Ballston Spa Elementary School that is not on campus. Street parking only. Enter through the doors to the left on the main entrance to get into the elevator."
  },
  {
  ...
  },
  {
    ...
    "irm": 24,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: Rotterdam - they brought us 2-3 kids at a time at a very slow pace so no assistant needed here again (MES 12/17/24)"
  },
  {
  ...
  },
  {
    ...
    "irm": 91,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: 9/19/25: 2 shooters and one class pic shooter was a little challenging - have at least one  assistant in the future? (MES)"
  },
  {
    "name": "D'burg MS/HS",
    "irm": 42,
  ...
  },
  {
    ...
    "irm": 59,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: Parking in front of the school, several visitor spots. Buzz in at the door, need your ID. Then go right once you get into the doors, and the gym is down the Hallway.  (MM Fall 2025)"
  },
  {
  ...
  },
  {
    ...
    "irm": 10,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: Park by the entrance to “The Local”, the preschool entrance is to the right and not  clearly marked (MS)"
  },
  {
  ...
  },
  {
    ...
    "irm": 4,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: School Log contains a page for Maywood Academy - Capital Region BOCES; no additional note text was provided on that page."
  },
  {
  ...
  },
  {
    ...
    "irm": 29,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: School Log includes a building/map image showing the ramp entrance location for Pleasant Valley Elementary School."
  },
  {
  ...
  },
  {
    "name": "Shen - Arongen",
    "irm": 100,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: Need to get parent volunteer situation in check for next year (MS fall 2024)  On 3/20/2025, Mr. Hills, Principal, stated only 2 parent volunteers are allowed, the PTO  picture day contact and one other chosen by the PTO contact. (4/21/26 ckg)   Need assistant on picture makeup day (MS fall 2024)"
  },
  {
  ...
  },
  {
    "name": "Shen - Okte",
    "irm": 113,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: - Special needs/ISD classes are very challenging. Make sure to provide as much time as possible for yourself to get these photographed."
  },
  {
    "name": "Shen - Orenda",
    "irm": 100,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: Makeup Day 10/24/25 - PM Kindergarten doesn’t arrive until 11:45am  (schedule was wrong) (MS)"
  },
  {
    "name": "Shen - Shatekon",
    "irm": 89,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: School Log page also references Shatekon Elementary School; no additional note text was provided for Shatekon on that page."
  },
  {
    "name": "Shen - Skano",
    "irm": 100,
  ...
  },
  {
    "name": "TSL Troy",
    "irm": 12,
    "notes": "Seeded from Fall 2025 stats. Address to be added later.\n\nFrom School Log: New location next to the River. Playground is completely enclosed by fence. I photographed the students with a plastic house as the background 🙂 (MM Spring 2025)"
  },
  {
    "name": "Turner's Tots",
    "irm": 1,
  ...
  },
  {
    ...
    "irm": null,
    "notes": "Added from April 2026 Spring schedule import. Address/logistics to be added later.\n\nFrom School Log: Spring ‘25: They had us start at 7:30am and didn’t go in class order b/c most kids were  not there yet which was chaotic for assistants. The infant room they had us in was too  small to get wide/full body shots - ask for more space next time (MS 6/4/25)"
  },
  {
    "name": "Maple Leaf Malta North",
    "irm": null,
  ...
  },
  {
    ...
    "irm": null,
    "notes": "Added from February 2026 Spring schedule import. Address/logistics to be added later.\n\nFrom School Log: Traffic is CRAZY in this area in the morning so give yourself extra time to get there (MS)"
  }
];
